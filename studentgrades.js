...
var config = {
    connectionString: "AccountEndpoint=https://elmiracollegeschool.documents.azure.com:443/;AccountKey=oL0Sp2w7sVYgVedIb5nCieJDK7gu2Vvwxiu5E86vvFM6zRZrXNa28y7jkGzGrrUhG4c2ODADNVi0l6lOZjPGQw==",
    database: "SchoolDB",
...
class Student {
    constructor(ID, studentNumber, forename, lastname) {
        ...
        this.toString = function () {
            return `${this.StudentNumber}: ${this.Lastname}, ${this.Forename}\n`;
        };
